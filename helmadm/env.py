...
ENV_NAMESPACE = "HELM_TO_ARGOCD_NAMESPACE"
ENV_CONTEXT = "HELM_TO_ARGOCD_CONTEXT"
ENV_REPO_URL = "HELM_TO_ARGOCD_REPO_URL"
ENV_RELEASE_NAME = "HELM_TO_ARGOCD_RELEASE_NAME"
# Per-key values/diff trace logs (off unless set; use with --verbose).
ENV_TRACE_VALUES = "HELM_TO_ARGOCD_TRACE_VALUES"

# HTTP timeouts for all Kubernetes API calls (connect, read) in seconds as floats.
ENV_K8S_CONNECT_TIMEOUT = "HELM_TO_ARGOCD_K8S_CONNECT_TIMEOUT"
ENV_K8S_READ_TIMEOUT = "HELM_TO_ARGOCD_K8S_READ_TIMEOUT"
